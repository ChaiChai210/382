...
public class SPUtils {
    ...
    public boolean putObject(String key, Object value) {
        return editor.putString(key, JsonUtil.toJson(value)).commit();
    }
    ...
    public void setSafeBoxPwd(String paramString) {
        this.userPassword = paramString;
        this.editor.putString("safe", paramString).commit();
    }

    public String getSafeBoxPwd() {
        return sp.getString("safe", "");
    }
